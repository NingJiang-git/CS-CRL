...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 2, 'input_size': (1, 50, 50), 'pool_size': None,
...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=50, patch_size=10, in_chans=1, embed_dim=1000):
        super().__init__()
...
@register_model
def vit_base_patch10_50(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=10, embed_dim=1000, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True,
